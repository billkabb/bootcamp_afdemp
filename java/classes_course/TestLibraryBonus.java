...
public class TestLibraryBonus {
	...
	public static void main (String[] args) {
		...
		Librarian dude = new Librarian(library);
		
		do {
			System.out.print("Welcome to the Bootcamp library.\n"
			...
			{
				dude.findMeAvailableBooks();
				System.out.println();
			}
			else if(select.equalsIgnoreCase("2"))
			{
				System.out.print("Please enter the book title: ");
				String title = (String)in.next();
				System.out.println();
				dude.findMeBook(title);
				System.out.println();
			}
			else if(select.equalsIgnoreCase("3"))
			{
				System.out.print("Please enter the book author: ");
				String author = (String)in.next();
				System.out.println();
				dude.findMeBooksFromAuthor(author);
				System.out.println();
			}else{System.out.println("Please enter a valid selection or press < q > to leave the library ");
				System.out.println();}
		}while(!finish);
